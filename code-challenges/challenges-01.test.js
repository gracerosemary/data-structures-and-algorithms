  ...
  arr.forEach((number) => {
    if(number % 3 === 0){           // if number is divisible by 3
      if(number % 5 === 0){           // if number is divisible by 5  
        output.push('Fizz Buzz');       // add phrase Fizz Buzz to output 
      } else {                        // if the condition (divisible by 5) if false ...
        output.push('Fizz');          // add phrase Fizz to output (refers to if number is divisible by 3)
      }
    } else if (number % 5 === 0){       // new condition (divisble by 5) if the first condition (divisible by 3) is false ...
      output.push('Buzz');          // add phrase Buzz to output
    } else {                          // (otherwise) if all conditions are false ....
      output.push(number);          // add number to the output array
    }
  });
  return output;                    // return the resulting output array
};
